...
public class printNotification {
	...
	public static void main(String[] args) throws InterruptedException {		
		...
		try {
			...
			wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"root\"]/div/div/div[2]/div/div[1]/div/div/div/div")));
			
			WebElement printNotification = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div[2]/div/div[1]/div/div/div/div"));
			System.out.println(printNotification.getText());
