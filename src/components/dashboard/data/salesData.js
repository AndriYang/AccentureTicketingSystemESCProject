...
export const barChartMonthlyPercentages = [
  { name: 'IT', data: [14, 16, 19.5] },
  { name: 'Finance', data: [24, 23.5, 24.5] },
  { name: 'Recruitment', data: [12.5, 12.5, 14] },
  { name: 'General', data: [16, 18, 17] },
  { name: 'Others', data: [21.5, 20, 17] },
];
